<section class="about-section section-pad" id="about-tracer">
    <div class="container">
            ...
            <div class="col-lg-6">
                <div class="pe-lg-4">
                    ...
                    <h2 class="section-title mb-4">
                        Memahami jejak alumni dengan data yang lebih hidup.
                    </h2>

                    <p class="section-copy fs-5 mb-4">
                        Tracer study adalah studi pelacakan alumni untuk melihat transisi lulusan dari kampus menuju
                        dunia kerja. Hasilnya membantu jurusan mengambil keputusan berbasis data.
                    </p>
